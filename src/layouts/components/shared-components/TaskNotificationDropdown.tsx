...
// ** Icons Imports
import { CalendarCheckOutline } from 'mdi-material-ui'
...
import { IMessage, MessageType, selectBoardMessages, selectBoardUnreadCount } from '@/redux/slices/messageSlice'
...
const TaskNotificationDropdown = () => {
  // ** States
  const [anchorEl, setAnchorEl] = useState<(EventTarget & Element) | null>(null)

  // ** Global State
  const messages = useSelector(selectBoardMessages)
  const unreadCount = useSelector(selectBoardUnreadCount)
  ...
  return (
    <Fragment>
      ...
      >
        ...
        >
          {unreadCount ? (
            <Button fullWidth variant='outlined' color='info' onClick={handleTickUnreadMessagesAsRead}>
...
export default TaskNotificationDropdown
