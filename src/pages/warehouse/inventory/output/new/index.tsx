...
// ** Components Imports
import StockSelect, { InventoryItemType } from '@/components/StockSelect'
...
const InventoryOutputCreate = () => {
  ...
  const handleReturnToList = () => {
    router.push(`/warehouse/inventory/output`)
  }
...
export default InventoryOutputCreate
